...
public class LoginProcessServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String url="jdbc:mysql://localhost:3306/hms_db";
         String user="root";
        String password="";
        String Query=" select `name`,`pwd` from `accts` where `uname`='"+uname+"'";
       ...
       try
       {
            ...
            while(rs.next())
            {
                ...
                {
                out.println("<body bgcolor='Magenta'><center><br><br><h3>Invalid Credentials<br><a href=\"http://localhost:8084/hms/login.html\">Try again</a></h3></center></body>");

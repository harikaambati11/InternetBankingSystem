...
public class RegProcessServlet1 extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException 
    {
        ...
        String url="jdbc:mysql://localhost:3306/hms_db";
         String user="root";
        String password="";
        String Query="insert into eaccts values('"+ename+"','"+email+"','"+mno+"', '"+uname+"','"+pwd+"')";
        try{
            ...
            //request.getRequestDispatcher("login.html").include(request,response);
                out.println("<body bgcolor='Magenta'><center><br><br><h3>Registration successful<br><a href=\"http://localhost:8084/hms/login1.html\">Login now</a></h3></center></body>");
            else 
